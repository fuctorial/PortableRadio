...
public class GuiWalkieTalkie extends GuiContainer {
    ...
    public void initGui() {
        ...
        yOffset += 25;
        this.microphoneSelector = new GuiAudioDeviceSelector(2, componentX, yOffset, componentWidth - 25, 20, "gui.portableradio.microphone", true, ClientConfig.getSelectedMicIndex());
        ...
        yOffset += 25;
        this.speakerSelector = new GuiAudioDeviceSelector(3, componentX, yOffset, componentWidth - 25, 20, "gui.portableradio.speaker", false, ClientConfig.getSelectedSpeakerIndex());
